...
angular.module('tm.pagination', []).directive('tmPagination',[function(){
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '<li page-repeat ng-repeat="item in pageList track by $index"  ng-class="{active: item == conf.currentPage, separate: item == \'...\'}" '  +
...
//          }
            ...
            function getPagination(newValue, oldValue) {
            	console.log("conf.currentPage ",conf.currentPage);
            	console.log("scope.conf.currentPage ",scope.conf.currentPage);
                ...
                console.log("conf.numberOfPages ",conf.numberOfPages);
